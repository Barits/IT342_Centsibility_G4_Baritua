...
const TodaySpending = ({ spent, dailyAverage }) => {
  if (spent === null || spent === undefined || dailyAverage === null || dailyAverage === undefined) {
    return (
      <EmptyState
        title="No spending summary yet"
        description="Hook this section up to the backend transaction summary endpoint to show live spending totals."
      />
    );
  }
